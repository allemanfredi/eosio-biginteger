...
void BigUnsigned::subtract(const BigUnsigned &a, const BigUnsigned &b) {
	...
	if (b.len == 0) {
		...
		eosio::check( a.len >= b.len, "BigUnsigned::subtract: Negative result in unsigned calculation");
		//swapnibble
		/*
		if (a.len < b.len)
	...
	if (borrowIn) {
		...
		eosio::check(0, "BigUnsigned::subtract: Negative result in unsigned calculation");
	} else
...
void BigUnsigned::bitShiftLeft(const BigUnsigned &a, int b) {
	...
	if (b < 0) {
		//swapnibble
		eosio::check( b << 1 != 0, "BigUnsigned::bitShiftLeft: Pathological shift amount not implemented" );
...
void BigUnsigned::bitShiftRight(const BigUnsigned &a, int b) {
	...
	if (b < 0) {
		//swapnibble
		eosio::check( b << 1 != 0, "BigUnsigned::bitShiftRight: Pathological shift amount not implemented" );
...
void BigUnsigned::print() const {
	std::string s = bigUnsignedToString(*this);
	eosio::print(s);
}
...
void BigUnsigned::operator --() {
	//swapnibble
	eosio::check( len != 0, "BigUnsigned::operator --(): Cannot decrement an unsigned zero");
	// if (len == 0)
 ...
 * any necessary temporary copies to work around aliasing. */
 ...
 BigUnsigned BigUnsigned::operator /(const BigUnsigned &x) const {
	...
	eosio::check( !x.isZero(), "BigUnsigned::operator /: division by zero");
